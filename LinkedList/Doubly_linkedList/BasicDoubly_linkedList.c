//THIS PROGRAM IS ONLY FOR INSERT FROM FRONT AND REAR / DISPLAY (Doubly LL)
#include <stdio.h>
#include <stdlib.h>
...
NODE create_node(int ele) {
    ...
    temp->info = ele;
    temp->next = NULL;
    temp->prev = NULL;   // initialize prev
    return temp;
}
